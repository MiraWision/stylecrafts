...
const ImageCompressionIcon: React.FC<IconProps> = (props) => {
  return (
    <Icon {...props}>
      <path d='M6.5 14.75L9.25 12L10.125 13L11 14' stroke='#9CA3AF' stroke-linecap='round' stroke-linejoin='round'/>
      <path d='M10 12.75L12.25 10.5L16.5 14.75' stroke='#9CA3AF' stroke-linecap='round' stroke-linejoin='round'/>
      <circle cx='17' cy='10.25' r='1' stroke='#9CA3AF'/>
      <path d='M12 3V6.75M12 6.75L12.75 5.75H11.25L12 6.75Z' stroke='#9CA3AF' stroke-linecap='round' stroke-linejoin='round'/>
      <path d='M12 20.5V16.75M12 16.75L11.25 17.75H12.75L12 16.75Z' stroke='#9CA3AF' stroke-linecap='round' stroke-linejoin='round'/>

...
const GameIcon: React.FC<IconProps> = (props) => {
  return (
    <Icon {...props}>
      ...
      <path d='M15.5 12H19M13.5 14H19.5M13 16H19' stroke='#9CA3AF' strokeLinecap='round' strokeLinejoin='round'/>
      <path d='M8 11.5L4.5 14M10 13L5.5 16.5M10.5 15.5L7.5 18' stroke='#9CA3AF' strokeLinecap='round' strokeLinejoin='round'/>
    </Icon>
  );
}

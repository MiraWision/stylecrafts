...
const BlogCreatingColorStepsForHeatmapsPage = () => {
  const post = blogPosts.find((post) => post.url === 'creating-color-steps-for-heatmaps');
...
export default BlogCreatingColorStepsForHeatmapsPage;

...
const BlogOptimizingImagesForTheWebPage = () => {
  const post = blogPosts.find((post) => post.url === 'optimizing-images-for-the-web');
...
export default BlogOptimizingImagesForTheWebPage;

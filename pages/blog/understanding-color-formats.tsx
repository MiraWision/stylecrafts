...
const BlogUnderstandingColorFormatsPage = () => {
  const post = blogPosts.find((post) => post.url === 'understanding-color-formats');
...
export default BlogUnderstandingColorFormatsPage;

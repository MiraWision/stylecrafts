...
> Start creating effective heatmaps with custom stepped gradients. Try our [Colors Gradient Generator](/colors/colors-gradient) now and transform your data visualizations.
`;
